...
export type ThunkAuthType = ThunkAction<void, AuthDataType, unknown, AuthReducerActionType>

// THUNK CREATORS
export const getAuthUserDataTC = (): ThunkAuthType => (dispatch) => {
    return authAPI.authGet()
        .then(response => {
